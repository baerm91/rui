...
function NewStory({ session }) {
  ...
  async function submit(event) {
    ...
    if (!isValidModelUrl(modelUrl)) { setError('Bitte geben Sie eine vollständige HTTP(S)-URL zu einer .fbx-, .glb- oder .gltf-Datei oder zu einem Sketchfab-Modell ein.'); return; }
