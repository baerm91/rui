...
export function SpatialObjectDetails({ item, className = '', showTitle = true }) {
  if (!item) return null;
  ...
  return <div className={className}>
    ...
    {item.description && <p className="spatial-object-description">{item.description}</p>}
    {(item.attribution || item.license) && <div className="spatial-object-rights" aria-label="Urheber und Lizenz">
    ...
    {sourceUrl && <a className="spatial-object-source" href={sourceUrl} target="_blank" rel="noreferrer">
